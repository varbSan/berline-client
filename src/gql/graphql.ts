...
export type Mutation = {
  __typename?: 'Mutation';
  createQueuePoint: QueuePointType;
};
...
export type CreateQueuePointMutation = { __typename?: 'Mutation', createQueuePoint: { __typename?: 'QueuePointType', row: number } };

export type GetLastQueuePointQueryVariables = Exact<{ [key: string]: never; }>;


export type GetLastQueuePointQuery = { __typename?: 'Query', getLastQueuePoint: { __typename?: 'QueuePointType', row: number } };
